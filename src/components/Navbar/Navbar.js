...
const Navbar = () => {
  ...
  const getMenuContent = () => {
    const url =
      "https://api.archive-of-spatial-knowledge.org/cms/getmenuContent";
    console.log("start");
    axios
      .get(`${url}`)
      .then((response) => {
  ...
  function UnsafeComponent({ html }) {
    return (
      <div className="unsafe-html" dangerouslySetInnerHTML={{ __html: html }} />
    );
  }
              ...
              {optionsList.map((option, index) => (
                ...
                >
                  ...
                  option == "Colophon" ? (
                    ...
                    <Link to={"Page/" + option}>{option}</Link>
                  )}
                </li>
              ))}
            </ul>
        ...
        <>
          <section className="menubottomoptions">
            <ul className="menubottomtwinimg">
              <li>
                <Link to="Page/Contribute">Contribute</Link>
              </li>
            </ul>
            ...
            <ul className="eventslistul">
              ...
              <li>
                <a
                  href="https://spatial-knowledge.org/Page/Updates"
            ...
            <ul className="downloadreader">
              <li>
                ...
                <p className="downloadmobile mb-0">
                  *Mobile application inactive
                </p>
              </li>
            </ul>
          </section>
